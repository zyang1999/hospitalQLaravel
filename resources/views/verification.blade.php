                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($patients as $patient)
                                ...
                                <td>{{$patient->IC_no}}</td>
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-id={{ $patient->id }}>
                                        Review
                                    </button>
                                </td>
                              </tr>
                ...
                <div class="modal-body">
                    ...
                    <div class="row align-items-start">
                        <div class="col">
                            ...
                            <textarea type="text" class="form-control" disabled id="address" ></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="approve()" id="approveButton">Approve</button>   
                    <button type="button" class="btn btn-danger" onclick="reject()" id="rejectButton">Reject</button>              
